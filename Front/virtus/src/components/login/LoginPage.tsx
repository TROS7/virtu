...
import '../../styles/log.css'; // Estilos prop ios (log.css)
...
const LoginPage = () => {
  ...
  // handleSubmit con parámetros correctamente tipados
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    $.ajax({
      ...
      dataType: 'json',
      success: function (response: { success: boolean; redirect: string; message: string; }) {
        if (response.success) {
